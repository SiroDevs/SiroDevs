...
export default function HeroSection() {
  ...
  return (
    <section className="flex flex-col items-center justify-between py-2 lg:py-5">
      ...
      <a
        className="flex items-center gap-1 hover:gap-3 rounded-full bg-gradient-to-r from-red-600 to-red-900 px-3 md:px-8 py-3 md:py-4 text-center text-xs md:text-sm font-medium uppercase tracking-wider text-white no-underline transition-all duration-200 ease-out hover:text-white hover:no-underline md:font-semibold"
        href={AppUrls.android}
        target="_blank"
        rel="noopener noreferrer"
      >
        <span className="text-xl">Get BibleLib Today</span>
        <MdDownload size={16} />
      </a>
