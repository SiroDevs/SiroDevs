...
export default function GlowCard({ children, identifier }: GlowCardProps) {
  ...
  return (
    <div className={`glow-container-${identifier} glow-container drop-shadow-3xl`}>
      <article
        className={`glow-card glow-card-${identifier} h-fit cursor-pointer border border-[#ccc] transition-all duration-300 relative bg-[#3A1300] text-[#EEDAC4] rounded-xl hover:border-transparent w-full`}
      >
