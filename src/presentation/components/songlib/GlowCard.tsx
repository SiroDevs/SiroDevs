...
/**
 * A card that lights up a conic-gradient border as the pointer passes near
 * it. Ported as-is from the standalone SongLib app; styling lives in
 * songlib.scss, scoped under `.songlib-scope`.
 */
